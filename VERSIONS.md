...
| v1.2    | 2026-05-28 | —        | Project rows: more space between title and tag row (`8px` → `20px`). |
| v1.3    | 2026-05-28 | —        | Tag category filter on home work section and `/work` page (All + unique tags). |
| v1.4    | 2026-05-28 | —        | Filter limited to Branding, B2B / SaaS, Mobile, Product, UI/UX; card display tags unchanged. |
